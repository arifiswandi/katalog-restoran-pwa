const itActsAsFavoriteRestaurantModel = (favoriteRestaurant) => {
  ...
  it('should be able to search for restaurants', async () => {
    favoriteRestaurant.putRestaurant({ id: 1, name: 'makan a' });
    favoriteRestaurant.putRestaurant({ id: 2, name: 'makan b' });
    favoriteRestaurant.putRestaurant({ id: 3, name: 'makan abc' });
    favoriteRestaurant.putRestaurant({ id: 4, name: 'ini mah makan abcd' });

    expect(await favoriteRestaurant.searchRestaurants('makan a')).toEqual([
      { id: 1, name: 'makan a' },
      { id: 3, name: 'makan abc' },
      { id: 4, name: 'ini mah makan abcd' },
    ]);
  });
};
